...
def start(update, _):
    reply_keyboard = [['Рацианальные числа','Комплексные числа']]
    markup_key = ReplyKeyboardMarkup(reply_keyboard, one_time_keyboard=True)
    update.message.reply_text('Привет', reply_markup=markup_key)
    return CHOICE
...
def choice(update, context):
    ...
    if user_choice == 'Рацианальные числа':
